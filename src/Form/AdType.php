    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add(
                'slug',
                 TextType::class,
                 $this->getConfiguration("Adress web","Tapez l'adresse web (automatique )",['required'=>false]))
            ->add(
                'coverImage',
                 UrlType::class, 
            ...
            ->add(
                 'content',
                 TextareaType::class, 
                 $this->getConfiguration("Description détaillée","Tapez une description qui donne  vraiment envie de venir ches vous !"))
            ->add(
                 'rooms',
                 IntegerType::class,
